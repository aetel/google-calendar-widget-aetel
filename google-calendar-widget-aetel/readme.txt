=== AETEL Google Calendar Widget ===
Contributors: poco, rs
Tags: google, calendar, widget, aetel
Requires at least: 2.8
Tested up to: 4.7.2
Stable tag: 1.0

This plugin installs a sidebar widget that can show the upcoming events from a Google Calendar feed tuned for AETEL Theme V2.
...
* Calendar ID 3: <blank>
* Contact Email: contacto@emilio.org
